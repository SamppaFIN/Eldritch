 ...
 * asking more often does not earn more. The *reward moment* — the "+N" rising off the
 * pouch — is the Collect button now (BRDC-ECON-007), not this poll. Lifted out of MapView,
 * which was at its line ceiling; `setResources` comes back so a ward can push a fresh pool
 * straight in.
 */
